...
class Plot(): 
    ...
    def plot_polygon_mapbox(self, censo, geojd, center, filename = False, scalecolor = False):
        if scalecolor== False:
            scalecolor = "Viridis"
    ...
    def Latlon(self, file_name = False, scale_color = False, df = None, centro_map_lat = -999, centro_map_lon = -999, coordenadas_poligono = None):
        """
    ...
    def Latlon_n_poligonos(self, file_name = False, scale_color = False, df = None, centro_map_lat = -999, centro_map_lon = -999,coordenadas_poligono = None):
        """
        Función que plotea puntos en un mapa geográfico según la longitud y latitud
...
class Poligono():        
    ...
    def Interior_Poligono(dataframe, some_poly):
        """
    ...
    def Circunferencia(lat_center,lon_center,n_points = int,radio = float):
        """
