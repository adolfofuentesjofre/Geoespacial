...
class Plot(): 
    ...
    def plot_polygon_mapbox(self, censo, geojd, center, opacity = 0.4, filename = False, scalecolor = False):
        if scalecolor== False:
            scalecolor = "Viridis"
        ...
        fig = px.choropleth_mapbox(censo, geojson=geojd, 
                                   ...
                                   color = 'Densidad_poblacional_km2',
...
class Poligono():        
    ...
    def Circunferencia(lat_center,lon_center,n_points = int,radio = float):
        ...
        polygon = geog.propagate(p, angles, float(d))
